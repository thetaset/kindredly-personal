import{g as Ot}from"./sentryUtilsBulAlGyQ.js";var qe={exports:{}};(function($e){(Pe=>{var je=Object.defineProperty,Ye=Object.getOwnPropertyDescriptor,He=Object.getOwnPropertyNames,Qe=Object.prototype.hasOwnProperty,Xe=(e,n)=>{for(var r in n)je(e,r,{get:n[r],enumerable:!0})},Ke=(e,n,r,a)=>{if(n&&typeof n=="object"||typeof n=="function")for(let g of He(n))!Qe.call(e,g)&&g!==r&&je(e,g,{get:()=>n[g],enumerable:!(a=Ye(n,g))||a.enumerable});return e},Ze=e=>Ke(je({},"__esModule",{value:!0}),e),le=(e,n,r)=>new Promise((a,g)=>{var y=u=>{try{k(r.next(u))}catch(D){g(D)}},h=u=>{try{k(r.throw(u))}catch(D){g(D)}},k=u=>u.done?a(u.value):Promise.resolve(u.value).then(y,h);k((r=r.apply(e,n)).next())}),ye={};Xe(ye,{analyzeMetafile:()=>vt,analyzeMetafileSync:()=>kt,build:()=>gt,buildSync:()=>bt,context:()=>pt,default:()=>$t,formatMessages:()=>wt,formatMessagesSync:()=>_t,initialize:()=>St,stop:()=>Et,transform:()=>yt,transformSync:()=>xt,version:()=>mt}),Pe.exports=Ze(ye);function Ae(e){let n=a=>{if(a===null)r.write8(0);else if(typeof a=="boolean")r.write8(1),r.write8(+a);else if(typeof a=="number")r.write8(2),r.write32(a|0);else if(typeof a=="string")r.write8(3),r.write(Z(a));else if(a instanceof Uint8Array)r.write8(4),r.write(a);else if(a instanceof Array){r.write8(5),r.write32(a.length);for(let g of a)n(g)}else{let g=Object.keys(a);r.write8(6),r.write32(g.length);for(let y of g)r.write(Z(y)),n(a[y])}},r=new De;return r.write32(0),r.write32(e.id<<1|+!e.isRequest),n(e.value),Ce(r.buf,r.len-4,0),r.buf.subarray(0,r.len)}function et(e){let n=()=>{switch(r.read8()){case 0:return null;case 1:return!!r.read8();case 2:return r.read32();case 3:return ue(r.read());case 4:return r.read();case 5:{let h=r.read32(),k=[];for(let u=0;u<h;u++)k.push(n());return k}case 6:{let h=r.read32(),k={};for(let u=0;u<h;u++)k[ue(r.read())]=n();return k}default:throw new Error("Invalid packet")}},r=new De(e),a=r.read32(),g=(a&1)===0;a>>>=1;let y=n();if(r.ptr!==e.length)throw new Error("Invalid packet");return{id:a,isRequest:g,value:y}}var De=class{constructor(e=new Uint8Array(1024)){this.buf=e,this.len=0,this.ptr=0}_write(e){if(this.len+e>this.buf.length){let n=new Uint8Array((this.len+e)*2);n.set(this.buf),this.buf=n}return this.len+=e,this.len-e}write8(e){let n=this._write(1);this.buf[n]=e}write32(e){let n=this._write(4);Ce(this.buf,e,n)}write(e){let n=this._write(4+e.length);Ce(this.buf,e.length,n),this.buf.set(e,n+4)}_read(e){if(this.ptr+e>this.buf.length)throw new Error("Invalid packet");return this.ptr+=e,this.ptr-e}read8(){return this.buf[this._read(1)]}read32(){return Re(this.buf,this._read(4))}read(){let e=this.read32(),n=new Uint8Array(e),r=this._read(n.length);return n.set(this.buf.subarray(r,r+e)),n}},Z,ue,Oe;if(typeof TextEncoder<"u"&&typeof TextDecoder<"u"){let e=new TextEncoder,n=new TextDecoder;Z=r=>e.encode(r),ue=r=>n.decode(r),Oe='new TextEncoder().encode("")'}else if(typeof Buffer<"u")Z=e=>Buffer.from(e),ue=e=>{let{buffer:n,byteOffset:r,byteLength:a}=e;return Buffer.from(n,r,a).toString()},Oe='Buffer.from("")';else throw new Error("No UTF-8 codec found");if(!(Z("")instanceof Uint8Array))throw new Error(`Invariant violation: "${Oe} instanceof Uint8Array" is incorrectly false

This indicates that your JavaScript environment is broken. You cannot use
esbuild in this environment because esbuild relies on this invariant. This
is not a problem with esbuild. You need to fix your environment instead.
`);function Re(e,n){return e[n++]|e[n++]<<8|e[n++]<<16|e[n++]<<24}function Ce(e,n,r){e[r++]=n,e[r++]=n>>8,e[r++]=n>>16,e[r++]=n>>24}var J=JSON.stringify,Ue="warning",Ie="silent";function fe(e,n){const r=[];for(const a of e){if(Y(a,n),a.indexOf(",")>=0)throw new Error(`Invalid ${n}: ${a}`);r.push(a)}return r.join(",")}var we=()=>null,B=e=>typeof e=="boolean"?null:"a boolean",P=e=>typeof e=="string"?null:"a string",ve=e=>e instanceof RegExp?null:"a RegExp object",oe=e=>typeof e=="number"&&e===(e|0)?null:"an integer",tt=e=>typeof e=="number"&&e===(e|0)&&e>=0&&e<=65535?null:"a valid port number",Me=e=>typeof e=="function"?null:"a function",te=e=>Array.isArray(e)?null:"an array",q=e=>Array.isArray(e)&&e.every(n=>typeof n=="string")?null:"an array of strings",Q=e=>typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"an object",nt=e=>typeof e=="object"&&e!==null?null:"an array or an object",rt=e=>e instanceof WebAssembly.Module?null:"a WebAssembly.Module",Fe=e=>typeof e=="object"&&!Array.isArray(e)?null:"an object or null",Ne=e=>typeof e=="string"||typeof e=="boolean"?null:"a string or a boolean",st=e=>typeof e=="string"||typeof e=="object"&&e!==null&&!Array.isArray(e)?null:"a string or an object",Ve=e=>typeof e=="string"||Array.isArray(e)&&e.every(n=>typeof n=="string")?null:"a string or an array of strings",Le=e=>typeof e=="string"||e instanceof Uint8Array?null:"a string or a Uint8Array",it=e=>typeof e=="string"||e instanceof URL?null:"a string or a URL";function i(e,n,r,a){let g=e[r];if(n[r+""]=!0,g===void 0)return;let y=a(g);if(y!==null)throw new Error(`${J(r)} must be ${y}`);return g}function z(e,n,r){for(let a in e)if(!(a in n))throw new Error(`Invalid option ${r}: ${J(a)}`)}function lt(e){let n=Object.create(null),r=i(e,n,"wasmURL",it),a=i(e,n,"wasmModule",rt),g=i(e,n,"worker",B);return z(e,n,"in initialize() call"),{wasmURL:r,wasmModule:a,worker:g}}function Be(e){let n;if(e!==void 0){n=Object.create(null);for(let r in e){let a=e[r];if(typeof a=="string"||a===!1)n[r]=a;else throw new Error(`Expected ${J(r)} in mangle cache to map to either a string or false`)}}return n}function be(e,n,r,a,g){let y=i(n,r,"color",B),h=i(n,r,"logLevel",P),k=i(n,r,"logLimit",oe);y!==void 0?e.push(`--color=${y}`):a&&e.push("--color=true"),e.push(`--log-level=${h||g}`),e.push(`--log-limit=${k||0}`)}function Y(e,n,r){if(typeof e!="string")throw new Error(`Expected value for ${n}${r!==void 0?" "+J(r):""} to be a string, got ${typeof e} instead`);return e}function We(e,n,r){let a=i(n,r,"legalComments",P),g=i(n,r,"sourceRoot",P),y=i(n,r,"sourcesContent",B),h=i(n,r,"target",Ve),k=i(n,r,"format",P),u=i(n,r,"globalName",P),D=i(n,r,"mangleProps",ve),R=i(n,r,"reserveProps",ve),O=i(n,r,"mangleQuoted",B),V=i(n,r,"minify",B),C=i(n,r,"minifySyntax",B),M=i(n,r,"minifyWhitespace",B),F=i(n,r,"minifyIdentifiers",B),$=i(n,r,"lineLimit",oe),W=i(n,r,"drop",q),S=i(n,r,"dropLabels",q),E=i(n,r,"charset",P),p=i(n,r,"treeShaking",B),f=i(n,r,"ignoreAnnotations",B),s=i(n,r,"jsx",P),o=i(n,r,"jsxFactory",P),d=i(n,r,"jsxFragment",P),b=i(n,r,"jsxImportSource",P),x=i(n,r,"jsxDev",B),c=i(n,r,"jsxSideEffects",B),m=i(n,r,"define",Q),t=i(n,r,"logOverride",Q),l=i(n,r,"supported",Q),w=i(n,r,"pure",q),v=i(n,r,"keepNames",B),T=i(n,r,"platform",P),A=i(n,r,"tsconfigRaw",st),L=i(n,r,"absPaths",q);if(a&&e.push(`--legal-comments=${a}`),g!==void 0&&e.push(`--source-root=${g}`),y!==void 0&&e.push(`--sources-content=${y}`),h&&e.push(`--target=${fe(Array.isArray(h)?h:[h],"target")}`),k&&e.push(`--format=${k}`),u&&e.push(`--global-name=${u}`),T&&e.push(`--platform=${T}`),A&&e.push(`--tsconfig-raw=${typeof A=="string"?A:JSON.stringify(A)}`),V&&e.push("--minify"),C&&e.push("--minify-syntax"),M&&e.push("--minify-whitespace"),F&&e.push("--minify-identifiers"),$&&e.push(`--line-limit=${$}`),E&&e.push(`--charset=${E}`),p!==void 0&&e.push(`--tree-shaking=${p}`),f&&e.push("--ignore-annotations"),W)for(let _ of W)e.push(`--drop:${Y(_,"drop")}`);if(S&&e.push(`--drop-labels=${fe(S,"drop label")}`),L&&e.push(`--abs-paths=${fe(L,"abs paths")}`),D&&e.push(`--mangle-props=${ke(D)}`),R&&e.push(`--reserve-props=${ke(R)}`),O!==void 0&&e.push(`--mangle-quoted=${O}`),s&&e.push(`--jsx=${s}`),o&&e.push(`--jsx-factory=${o}`),d&&e.push(`--jsx-fragment=${d}`),b&&e.push(`--jsx-import-source=${b}`),x&&e.push("--jsx-dev"),c&&e.push("--jsx-side-effects"),m)for(let _ in m){if(_.indexOf("=")>=0)throw new Error(`Invalid define: ${_}`);e.push(`--define:${_}=${Y(m[_],"define",_)}`)}if(t)for(let _ in t){if(_.indexOf("=")>=0)throw new Error(`Invalid log override: ${_}`);e.push(`--log-override:${_}=${Y(t[_],"log override",_)}`)}if(l)for(let _ in l){if(_.indexOf("=")>=0)throw new Error(`Invalid supported: ${_}`);const N=l[_];if(typeof N!="boolean")throw new Error(`Expected value for supported ${J(_)} to be a boolean, got ${typeof N} instead`);e.push(`--supported:${_}=${N}`)}if(w)for(let _ of w)e.push(`--pure:${Y(_,"pure")}`);v&&e.push("--keep-names")}function ot(e,n,r,a,g){var y;let h=[],k=[],u=Object.create(null),D=null,R=null;be(h,n,u,r,a),We(h,n,u);let O=i(n,u,"sourcemap",Ne),V=i(n,u,"bundle",B),C=i(n,u,"splitting",B),M=i(n,u,"preserveSymlinks",B),F=i(n,u,"metafile",B),$=i(n,u,"outfile",P),W=i(n,u,"outdir",P),S=i(n,u,"outbase",P),E=i(n,u,"tsconfig",P),p=i(n,u,"resolveExtensions",q),f=i(n,u,"nodePaths",q),s=i(n,u,"mainFields",q),o=i(n,u,"conditions",q),d=i(n,u,"external",q),b=i(n,u,"packages",P),x=i(n,u,"alias",Q),c=i(n,u,"loader",Q),m=i(n,u,"outExtension",Q),t=i(n,u,"publicPath",P),l=i(n,u,"entryNames",P),w=i(n,u,"chunkNames",P),v=i(n,u,"assetNames",P),T=i(n,u,"inject",q),A=i(n,u,"banner",Q),L=i(n,u,"footer",Q),_=i(n,u,"entryPoints",nt),N=i(n,u,"absWorkingDir",P),I=i(n,u,"stdin",Q),U=(y=i(n,u,"write",B))!=null?y:g,H=i(n,u,"allowOverwrite",B),G=i(n,u,"mangleCache",Q);if(u.plugins=!0,z(n,u,`in ${e}() call`),O&&h.push(`--sourcemap${O===!0?"":`=${O}`}`),V&&h.push("--bundle"),H&&h.push("--allow-overwrite"),C&&h.push("--splitting"),M&&h.push("--preserve-symlinks"),F&&h.push("--metafile"),$&&h.push(`--outfile=${$}`),W&&h.push(`--outdir=${W}`),S&&h.push(`--outbase=${S}`),E&&h.push(`--tsconfig=${E}`),b&&h.push(`--packages=${b}`),p&&h.push(`--resolve-extensions=${fe(p,"resolve extension")}`),t&&h.push(`--public-path=${t}`),l&&h.push(`--entry-names=${l}`),w&&h.push(`--chunk-names=${w}`),v&&h.push(`--asset-names=${v}`),s&&h.push(`--main-fields=${fe(s,"main field")}`),o&&h.push(`--conditions=${fe(o,"condition")}`),d)for(let j of d)h.push(`--external:${Y(j,"external")}`);if(x)for(let j in x){if(j.indexOf("=")>=0)throw new Error(`Invalid package name in alias: ${j}`);h.push(`--alias:${j}=${Y(x[j],"alias",j)}`)}if(A)for(let j in A){if(j.indexOf("=")>=0)throw new Error(`Invalid banner file type: ${j}`);h.push(`--banner:${j}=${Y(A[j],"banner",j)}`)}if(L)for(let j in L){if(j.indexOf("=")>=0)throw new Error(`Invalid footer file type: ${j}`);h.push(`--footer:${j}=${Y(L[j],"footer",j)}`)}if(T)for(let j of T)h.push(`--inject:${Y(j,"inject")}`);if(c)for(let j in c){if(j.indexOf("=")>=0)throw new Error(`Invalid loader extension: ${j}`);h.push(`--loader:${j}=${Y(c[j],"loader",j)}`)}if(m)for(let j in m){if(j.indexOf("=")>=0)throw new Error(`Invalid out extension: ${j}`);h.push(`--out-extension:${j}=${Y(m[j],"out extension",j)}`)}if(_)if(Array.isArray(_))for(let j=0,se=_.length;j<se;j++){let X=_[j];if(typeof X=="object"&&X!==null){let ee=Object.create(null),ie=i(X,ee,"in",P),K=i(X,ee,"out",P);if(z(X,ee,"in entry point at index "+j),ie===void 0)throw new Error('Missing property "in" for entry point at index '+j);if(K===void 0)throw new Error('Missing property "out" for entry point at index '+j);k.push([K,ie])}else k.push(["",Y(X,"entry point at index "+j)])}else for(let j in _)k.push([j,Y(_[j],"entry point",j)]);if(I){let j=Object.create(null),se=i(I,j,"contents",Le),X=i(I,j,"resolveDir",P),ee=i(I,j,"sourcefile",P),ie=i(I,j,"loader",P);z(I,j,'in "stdin" object'),ee&&h.push(`--sourcefile=${ee}`),ie&&h.push(`--loader=${ie}`),X&&(R=X),typeof se=="string"?D=Z(se):se instanceof Uint8Array&&(D=se)}let re=[];if(f)for(let j of f)j+="",re.push(j);return{entries:k,flags:h,write:U,stdinContents:D,stdinResolveDir:R,absWorkingDir:N,nodePaths:re,mangleCache:Be(G)}}function at(e,n,r,a){let g=[],y=Object.create(null);be(g,n,y,r,a),We(g,n,y);let h=i(n,y,"sourcemap",Ne),k=i(n,y,"sourcefile",P),u=i(n,y,"loader",P),D=i(n,y,"banner",P),R=i(n,y,"footer",P),O=i(n,y,"mangleCache",Q);return z(n,y,`in ${e}() call`),h&&g.push(`--sourcemap=${h===!0?"external":h}`),k&&g.push(`--sourcefile=${k}`),u&&g.push(`--loader=${u}`),D&&g.push(`--banner=${D}`),R&&g.push(`--footer=${R}`),{flags:g,mangleCache:Be(O)}}function ct(e){const n={},r={didClose:!1,reason:""};let a={},g=0,y=0,h=new Uint8Array(16*1024),k=0,u=E=>{let p=k+E.length;if(p>h.length){let s=new Uint8Array(p*2);s.set(h),h=s}h.set(E,k),k+=E.length;let f=0;for(;f+4<=k;){let s=Re(h,f);if(f+4+s>k)break;f+=4,M(h.subarray(f,f+s)),f+=s}f>0&&(h.copyWithin(0,f,k),k-=f)},D=E=>{r.didClose=!0,E&&(r.reason=": "+(E.message||E));const p="The service was stopped"+r.reason;for(let f in a)a[f](p,null);a={}},R=(E,p,f)=>{if(r.didClose)return f("The service is no longer running"+r.reason,null);let s=g++;a[s]=(o,d)=>{try{f(o,d)}finally{E&&E.unref()}},E&&E.ref(),e.writeToStdin(Ae({id:s,isRequest:!0,value:p}))},O=(E,p)=>{if(r.didClose)throw new Error("The service is no longer running"+r.reason);e.writeToStdin(Ae({id:E,isRequest:!1,value:p}))},V=(E,p)=>le(null,null,function*(){try{if(p.command==="ping"){O(E,{});return}if(typeof p.key=="number"){const f=n[p.key];if(!f)return;const s=f[p.command];if(s){yield s(E,p);return}}throw new Error("Invalid command: "+p.command)}catch(f){const s=[ae(f,e,null,void 0,"")];try{O(E,{errors:s})}catch{}}}),C=!0,M=E=>{if(C){C=!1;let f=String.fromCharCode(...E);if(f!=="0.25.12")throw new Error(`Cannot start service: Host version "0.25.12" does not match binary version ${J(f)}`);return}let p=et(E);if(p.isRequest)V(p.id,p.value);else{let f=a[p.id];delete a[p.id],p.value.error?f(p.value.error,{}):f(null,p.value)}};return{readFromStdout:u,afterClose:D,service:{buildOrContext:({callName:E,refs:p,options:f,isTTY:s,defaultWD:o,callback:d})=>{let b=0;const x=y++,c={},m={ref(){++b===1&&p&&p.ref()},unref(){--b===0&&(delete n[x],p&&p.unref())}};n[x]=c,m.ref(),ut(E,x,R,O,m,e,c,f,s,o,(t,l)=>{try{d(t,l)}finally{m.unref()}})},transform:({callName:E,refs:p,input:f,options:s,isTTY:o,fs:d,callback:b})=>{const x=ze();let c=m=>{try{if(typeof f!="string"&&!(f instanceof Uint8Array))throw new Error('The input to "transform" must be a string or a Uint8Array');let{flags:t,mangleCache:l}=at(E,s,o,Ie),w={command:"transform",flags:t,inputFS:m!==null,input:m!==null?Z(m):typeof f=="string"?Z(f):f};l&&(w.mangleCache=l),R(p,w,(v,T)=>{if(v)return b(new Error(v),null);let A=de(T.errors,x),L=de(T.warnings,x),_=1,N=()=>{if(--_===0){let I={warnings:L,code:T.code,map:T.map,mangleCache:void 0,legalComments:void 0};"legalComments"in T&&(I.legalComments=T==null?void 0:T.legalComments),T.mangleCache&&(I.mangleCache=T==null?void 0:T.mangleCache),b(null,I)}};if(A.length>0)return b(me("Transform failed",A,L),null);T.codeFS&&(_++,d.readFile(T.code,(I,U)=>{I!==null?b(I,null):(T.code=U,N())})),T.mapFS&&(_++,d.readFile(T.map,(I,U)=>{I!==null?b(I,null):(T.map=U,N())})),N()})}catch(t){let l=[];try{be(l,s,{},o,Ie)}catch{}const w=ae(t,e,x,void 0,"");R(p,{command:"error",flags:l,error:w},()=>{w.detail=x.load(w.detail),b(me("Transform failed",[w],[]),null)})}};if((typeof f=="string"||f instanceof Uint8Array)&&f.length>1024*1024){let m=c;c=()=>d.writeFile(f,m)}c(null)},formatMessages:({callName:E,refs:p,messages:f,options:s,callback:o})=>{if(!s)throw new Error(`Missing second argument in ${E}() call`);let d={},b=i(s,d,"kind",P),x=i(s,d,"color",B),c=i(s,d,"terminalWidth",oe);if(z(s,d,`in ${E}() call`),b===void 0)throw new Error(`Missing "kind" in ${E}() call`);if(b!=="error"&&b!=="warning")throw new Error(`Expected "kind" to be "error" or "warning" in ${E}() call`);let m={command:"format-msgs",messages:ne(f,"messages",null,"",c),isWarning:b==="warning"};x!==void 0&&(m.color=x),c!==void 0&&(m.terminalWidth=c),R(p,m,(t,l)=>{if(t)return o(new Error(t),null);o(null,l.messages)})},analyzeMetafile:({callName:E,refs:p,metafile:f,options:s,callback:o})=>{s===void 0&&(s={});let d={},b=i(s,d,"color",B),x=i(s,d,"verbose",B);z(s,d,`in ${E}() call`);let c={command:"analyze-metafile",metafile:f};b!==void 0&&(c.color=b),x!==void 0&&(c.verbose=x),R(p,c,(m,t)=>{if(m)return o(new Error(m),null);o(null,t.result)})}}}}function ut(e,n,r,a,g,y,h,k,u,D,R){const O=ze(),V=e==="context",C=($,W)=>{const S=[];try{be(S,k,{},u,Ue)}catch{}const E=ae($,y,O,void 0,W);r(g,{command:"error",flags:S,error:E},()=>{E.detail=O.load(E.detail),R(me(V?"Context failed":"Build failed",[E],[]),null)})};let M;if(typeof k=="object"){const $=k.plugins;if($!==void 0){if(!Array.isArray($))return C(new Error('"plugins" must be an array'),"");M=$}}if(M&&M.length>0){if(y.isSync)return C(new Error("Cannot use plugins in synchronous API calls"),"");ft(n,r,a,g,y,h,k,M,O).then($=>{if(!$.ok)return C($.error,$.pluginName);try{F($.requestPlugins,$.runOnEndCallbacks,$.scheduleOnDisposeCallbacks)}catch(W){C(W,"")}},$=>C($,""));return}try{F(null,($,W)=>W([],[]),()=>{})}catch($){C($,"")}function F($,W,S){const E=y.hasFS,{entries:p,flags:f,write:s,stdinContents:o,stdinResolveDir:d,absWorkingDir:b,nodePaths:x,mangleCache:c}=ot(e,k,u,Ue,E);if(s&&!y.hasFS)throw new Error('The "write" option is unavailable in this environment');const m={command:"build",key:n,entries:p,flags:f,write:s,stdinContents:o,stdinResolveDir:d,absWorkingDir:b||D,nodePaths:x,context:V};$&&(m.plugins=$),c&&(m.mangleCache=c);const t=(v,T)=>{const A={errors:de(v.errors,O),warnings:de(v.warnings,O),outputFiles:void 0,metafile:void 0,mangleCache:void 0},L=A.errors.slice(),_=A.warnings.slice();v.outputFiles&&(A.outputFiles=v.outputFiles.map(ht)),v.metafile&&(A.metafile=JSON.parse(v.metafile)),v.mangleCache&&(A.mangleCache=v.mangleCache),v.writeToStdout!==void 0&&ue(v.writeToStdout).replace(/\n$/,""),W(A,(N,I)=>{if(L.length>0||N.length>0){const U=me("Build failed",L.concat(N),_.concat(I));return T(U,null,N,I)}T(null,A,N,I)})};let l,w;V&&(h["on-end"]=(v,T)=>new Promise(A=>{t(T,(L,_,N,I)=>{const U={errors:N,warnings:I};w&&w(L,_),l=void 0,w=void 0,a(v,U),A()})})),r(g,m,(v,T)=>{if(v)return R(new Error(v),null);if(!V)return t(T,(_,N)=>(S(),R(_,N)));if(T.errors.length>0)return R(me("Context failed",T.errors,T.warnings),null);let A=!1;const L={rebuild:()=>(l||(l=new Promise((_,N)=>{let I;w=(H,G)=>{I||(I=()=>H?N(H):_(G))};const U=()=>{r(g,{command:"rebuild",key:n},(G,re)=>{G?N(new Error(G)):I?I():U()})};U()})),l),watch:(_={})=>new Promise((N,I)=>{if(!y.hasFS)throw new Error('Cannot use the "watch" API in this environment');const U={},H=i(_,U,"delay",oe);z(_,U,"in watch() call");const G={command:"watch",key:n};H&&(G.delay=H),r(g,G,re=>{re?I(new Error(re)):N(void 0)})}),serve:(_={})=>new Promise((N,I)=>{if(!y.hasFS)throw new Error('Cannot use the "serve" API in this environment');const U={},H=i(_,U,"port",tt),G=i(_,U,"host",P),re=i(_,U,"servedir",P),j=i(_,U,"keyfile",P),se=i(_,U,"certfile",P),X=i(_,U,"fallback",P),ee=i(_,U,"cors",Q),ie=i(_,U,"onRequest",Me);z(_,U,"in serve() call");const K={command:"serve",key:n,onRequest:!!ie};if(H!==void 0&&(K.port=H),G!==void 0&&(K.host=G),re!==void 0&&(K.servedir=re),j!==void 0&&(K.keyfile=j),se!==void 0&&(K.certfile=se),X!==void 0&&(K.fallback=X),ee){const pe={},he=i(ee,pe,"origin",Ve);z(ee,pe,'on "cors" object'),Array.isArray(he)?K.corsOrigin=he:he!==void 0&&(K.corsOrigin=[he])}r(g,K,(pe,he)=>{if(pe)return I(new Error(pe));ie&&(h["serve-request"]=(Pt,jt)=>{ie(jt.args),a(Pt,{})}),N(he)})}),cancel:()=>new Promise(_=>{if(A)return _();r(g,{command:"cancel",key:n},()=>{_()})}),dispose:()=>new Promise(_=>{if(A)return _();A=!0,r(g,{command:"dispose",key:n},()=>{_(),S(),g.unref()})})};g.ref(),R(null,L)})}}var ft=(e,n,r,a,g,y,h,k,u)=>le(null,null,function*(){let D=[],R=[],O={},V={},C=[],M=0,F=0,$=[],W=!1;k=[...k];for(let p of k){let f={};if(typeof p!="object")throw new Error(`Plugin at index ${F} must be an object`);const s=i(p,f,"name",P);if(typeof s!="string"||s==="")throw new Error(`Plugin at index ${F} is missing a name`);try{let o=i(p,f,"setup",Me);if(typeof o!="function")throw new Error("Plugin is missing a setup function");z(p,f,`on plugin ${J(s)}`);let d={name:s,onStart:!1,onEnd:!1,onResolve:[],onLoad:[]};F++;let x=o({initialOptions:h,resolve:(c,m={})=>{if(!W)throw new Error('Cannot call "resolve" before plugin setup has completed');if(typeof c!="string")throw new Error("The path to resolve must be a string");let t=Object.create(null),l=i(m,t,"pluginName",P),w=i(m,t,"importer",P),v=i(m,t,"namespace",P),T=i(m,t,"resolveDir",P),A=i(m,t,"kind",P),L=i(m,t,"pluginData",we),_=i(m,t,"with",Q);return z(m,t,"in resolve() call"),new Promise((N,I)=>{const U={command:"resolve",path:c,key:e,pluginName:s};if(l!=null&&(U.pluginName=l),w!=null&&(U.importer=w),v!=null&&(U.namespace=v),T!=null&&(U.resolveDir=T),A!=null)U.kind=A;else throw new Error('Must specify "kind" when calling "resolve"');L!=null&&(U.pluginData=u.store(L)),_!=null&&(U.with=dt(_,"with")),n(a,U,(H,G)=>{H!==null?I(new Error(H)):N({errors:de(G.errors,u),warnings:de(G.warnings,u),path:G.path,external:G.external,sideEffects:G.sideEffects,namespace:G.namespace,suffix:G.suffix,pluginData:u.load(G.pluginData)})})})},onStart(c){let m='This error came from the "onStart" callback registered here:',t=xe(new Error(m),g,"onStart");D.push({name:s,callback:c,note:t}),d.onStart=!0},onEnd(c){let m='This error came from the "onEnd" callback registered here:',t=xe(new Error(m),g,"onEnd");R.push({name:s,callback:c,note:t}),d.onEnd=!0},onResolve(c,m){let t='This error came from the "onResolve" callback registered here:',l=xe(new Error(t),g,"onResolve"),w={},v=i(c,w,"filter",ve),T=i(c,w,"namespace",P);if(z(c,w,`in onResolve() call for plugin ${J(s)}`),v==null)throw new Error("onResolve() call is missing a filter");let A=M++;O[A]={name:s,callback:m,note:l},d.onResolve.push({id:A,filter:ke(v),namespace:T||""})},onLoad(c,m){let t='This error came from the "onLoad" callback registered here:',l=xe(new Error(t),g,"onLoad"),w={},v=i(c,w,"filter",ve),T=i(c,w,"namespace",P);if(z(c,w,`in onLoad() call for plugin ${J(s)}`),v==null)throw new Error("onLoad() call is missing a filter");let A=M++;V[A]={name:s,callback:m,note:l},d.onLoad.push({id:A,filter:ke(v),namespace:T||""})},onDispose(c){C.push(c)},esbuild:g.esbuild});x&&(yield x),$.push(d)}catch(o){return{ok:!1,error:o,pluginName:s}}}y["on-start"]=(p,f)=>le(null,null,function*(){u.clear();let s={errors:[],warnings:[]};yield Promise.all(D.map(o=>le(null,[o],function*({name:d,callback:b,note:x}){try{let c=yield b();if(c!=null){if(typeof c!="object")throw new Error(`Expected onStart() callback in plugin ${J(d)} to return an object`);let m={},t=i(c,m,"errors",te),l=i(c,m,"warnings",te);z(c,m,`from onStart() callback in plugin ${J(d)}`),t!=null&&s.errors.push(...ne(t,"errors",u,d,void 0)),l!=null&&s.warnings.push(...ne(l,"warnings",u,d,void 0))}}catch(c){s.errors.push(ae(c,g,u,x&&x(),d))}}))),r(p,s)}),y["on-resolve"]=(p,f)=>le(null,null,function*(){let s={},o="",d,b;for(let x of f.ids)try{({name:o,callback:d,note:b}=O[x]);let c=yield d({path:f.path,importer:f.importer,namespace:f.namespace,resolveDir:f.resolveDir,kind:f.kind,pluginData:u.load(f.pluginData),with:f.with});if(c!=null){if(typeof c!="object")throw new Error(`Expected onResolve() callback in plugin ${J(o)} to return an object`);let m={},t=i(c,m,"pluginName",P),l=i(c,m,"path",P),w=i(c,m,"namespace",P),v=i(c,m,"suffix",P),T=i(c,m,"external",B),A=i(c,m,"sideEffects",B),L=i(c,m,"pluginData",we),_=i(c,m,"errors",te),N=i(c,m,"warnings",te),I=i(c,m,"watchFiles",q),U=i(c,m,"watchDirs",q);z(c,m,`from onResolve() callback in plugin ${J(o)}`),s.id=x,t!=null&&(s.pluginName=t),l!=null&&(s.path=l),w!=null&&(s.namespace=w),v!=null&&(s.suffix=v),T!=null&&(s.external=T),A!=null&&(s.sideEffects=A),L!=null&&(s.pluginData=u.store(L)),_!=null&&(s.errors=ne(_,"errors",u,o,void 0)),N!=null&&(s.warnings=ne(N,"warnings",u,o,void 0)),I!=null&&(s.watchFiles=_e(I,"watchFiles")),U!=null&&(s.watchDirs=_e(U,"watchDirs"));break}}catch(c){s={id:x,errors:[ae(c,g,u,b&&b(),o)]};break}r(p,s)}),y["on-load"]=(p,f)=>le(null,null,function*(){let s={},o="",d,b;for(let x of f.ids)try{({name:o,callback:d,note:b}=V[x]);let c=yield d({path:f.path,namespace:f.namespace,suffix:f.suffix,pluginData:u.load(f.pluginData),with:f.with});if(c!=null){if(typeof c!="object")throw new Error(`Expected onLoad() callback in plugin ${J(o)} to return an object`);let m={},t=i(c,m,"pluginName",P),l=i(c,m,"contents",Le),w=i(c,m,"resolveDir",P),v=i(c,m,"pluginData",we),T=i(c,m,"loader",P),A=i(c,m,"errors",te),L=i(c,m,"warnings",te),_=i(c,m,"watchFiles",q),N=i(c,m,"watchDirs",q);z(c,m,`from onLoad() callback in plugin ${J(o)}`),s.id=x,t!=null&&(s.pluginName=t),l instanceof Uint8Array?s.contents=l:l!=null&&(s.contents=Z(l)),w!=null&&(s.resolveDir=w),v!=null&&(s.pluginData=u.store(v)),T!=null&&(s.loader=T),A!=null&&(s.errors=ne(A,"errors",u,o,void 0)),L!=null&&(s.warnings=ne(L,"warnings",u,o,void 0)),_!=null&&(s.watchFiles=_e(_,"watchFiles")),N!=null&&(s.watchDirs=_e(N,"watchDirs"));break}}catch(c){s={id:x,errors:[ae(c,g,u,b&&b(),o)]};break}r(p,s)});let S=(p,f)=>f([],[]);R.length>0&&(S=(p,f)=>{le(null,null,function*(){const s=[],o=[];for(const{name:d,callback:b,note:x}of R){let c,m;try{const t=yield b(p);if(t!=null){if(typeof t!="object")throw new Error(`Expected onEnd() callback in plugin ${J(d)} to return an object`);let l={},w=i(t,l,"errors",te),v=i(t,l,"warnings",te);z(t,l,`from onEnd() callback in plugin ${J(d)}`),w!=null&&(c=ne(w,"errors",u,d,void 0)),v!=null&&(m=ne(v,"warnings",u,d,void 0))}}catch(t){c=[ae(t,g,u,x&&x(),d)]}if(c){s.push(...c);try{p.errors.push(...c)}catch{}}if(m){o.push(...m);try{p.warnings.push(...m)}catch{}}}f(s,o)})});let E=()=>{for(const p of C)setTimeout(()=>p(),0)};return W=!0,{ok:!0,requestPlugins:$,runOnEndCallbacks:S,scheduleOnDisposeCallbacks:E}});function ze(){const e=new Map;let n=0;return{clear(){e.clear()},load(r){return e.get(r)},store(r){if(r===void 0)return-1;const a=n++;return e.set(a,r),a}}}function xe(e,n,r){let a,g=!1;return()=>{if(g)return a;g=!0;try{let y=(e.stack+"").split(`
`);y.splice(1,1);let h=Ge(n,y,r);if(h)return a={text:e.message,location:h},a}catch{}}}function ae(e,n,r,a,g){let y="Internal error",h=null;try{y=(e&&e.message||e)+""}catch{}try{h=Ge(n,(e.stack+"").split(`
`),"")}catch{}return{id:"",pluginName:g,text:y,location:h,notes:a?[a]:[],detail:r?r.store(e):-1}}function Ge(e,n,r){let a="    at ";if(e.readFileSync&&!n[0].startsWith(a)&&n[1].startsWith(a))for(let g=1;g<n.length;g++){let y=n[g];if(y.startsWith(a))for(y=y.slice(a.length);;){let h=/^(?:new |async )?\S+ \((.*)\)$/.exec(y);if(h){y=h[1];continue}if(h=/^eval at \S+ \((.*)\)(?:, \S+:\d+:\d+)?$/.exec(y),h){y=h[1];continue}if(h=/^(\S+):(\d+):(\d+)$/.exec(y),h){let k;try{k=e.readFileSync(h[1],"utf8")}catch{break}let u=k.split(/\r\n|\r|\n|\u2028|\u2029/)[+h[2]-1]||"",D=+h[3]-1,R=u.slice(D,D+r.length)===r?r.length:0;return{file:h[1],namespace:"file",line:+h[2],column:Z(u.slice(0,D)).length,length:Z(u.slice(D,D+R)).length,lineText:u+`
`+n.slice(1).join(`
...
${k}:${u}:${D}: ERROR: ${R}${y.text}`}).join("");let g=new Error(e);for(const[y,h]of[["errors",n],["warnings",r]])Object.defineProperty(g,y,{configurable:!0,enumerable:!0,get:()=>h,set:k=>Object.defineProperty(g,y,{configurable:!0,enumerable:!0,value:k})});return g}function de(e,n){for(const r of e)r.detail=n.load(r.detail);return e}function Je(e,n,r){if(e==null)return null;let a={},g=i(e,a,"file",P),y=i(e,a,"namespace",P),h=i(e,a,"line",oe),k=i(e,a,"column",oe),u=i(e,a,"length",oe),D=i(e,a,"lineText",P),R=i(e,a,"suggestion",P);if(z(e,a,n),D){const O=D.slice(0,(k&&k>0?k:0)+(u&&u>0?u:0)+(r&&r>0?r:80));!/[\x7F-\uFFFF]/.test(O)&&!/\n/.test(D)&&(D=O)}return{file:g||"",namespace:y||"",line:h||0,column:k||0,length:u||0,lineText:D||"",suggestion:R||""}}function ne(e,n,r,a,g){let y=[],h=0;for(const k of e){let u={},D=i(k,u,"id",P),R=i(k,u,"pluginName",P),O=i(k,u,"text",P),V=i(k,u,"location",Fe),C=i(k,u,"notes",te),M=i(k,u,"detail",we),F=`in element ${h} of "${n}"`;z(k,u,F);let $=[];if(C)for(const W of C){let S={},E=i(W,S,"text",P),p=i(W,S,"location",Fe);z(W,S,F),$.push({text:E||"",location:Je(p,F,g)})}y.push({id:D||"",pluginName:R||a,text:O||"",location:Je(V,F,g),notes:$,detail:r?r.store(M):-1}),h++}return y}function _e(e,n){const r=[];for(const a of e){if(typeof a!="string")throw new Error(`${J(n)} must be an array of strings`);r.push(a)}return r}function dt(e,n){const r=Object.create(null);for(const a in e){const g=e[a];if(typeof g!="string")throw new Error(`key ${J(a)} in object ${J(n)} must be a string`);r[a]=g}return r}function ht({path:e,contents:n,hash:r}){let a=null;return{path:e,contents:n,hash:r,get text(){const g=this.contents;return(a===null||g!==n)&&(n=g,a=ue(g)),a}}}function ke(e){let n=e.source;return e.flags&&(n=`(?${e.flags})${n}`),n}var mt="0.25.12",gt=e=>ge().build(e),pt=e=>ge().context(e),yt=(e,n)=>ge().transform(e,n),wt=(e,n)=>ge().formatMessages(e,n),vt=(e,n)=>ge().analyzeMetafile(e,n),bt=()=>{throw new Error('The "buildSync" API only works in node')},xt=()=>{throw new Error('The "transformSync" API only works in node')},_t=()=>{throw new Error('The "formatMessagesSync" API only works in node')},kt=()=>{throw new Error('The "analyzeMetafileSync" API only works in node')},Et=()=>(Ee&&Ee(),Promise.resolve()),ce,Ee,Se,ge=()=>{if(Se)return Se;throw ce?new Error('You need to wait for the promise returned from "initialize" to be resolved before calling this'):new Error('You need to call "initialize" before calling this')},St=e=>{e=lt(e||{});let n=e.wasmURL,r=e.wasmModule,a=e.worker!==!1;if(!n&&!r)throw new Error('Must provide either the "wasmURL" option or the "wasmModule" option');if(ce)throw new Error('Cannot call "initialize" more than once');return ce=Tt(n||"",r,a),ce.catch(()=>{ce=void 0}),ce},Tt=(e,n,r)=>le(null,null,function*(){let a,g;const y=new Promise(O=>g=O);if(r){let O=new Blob([`onmessage=((postMessage) => {
