...
import {extractMetadata} from 'tset-sharedlib/extraction.utils';
import {urlToKey} from 'tset-sharedlib/text.utils';

function filterToFields<T extends object, K extends keyof T>(fields: readonly K[], obj: T): Pick<T, K> {
...
export {extractMetadata, filterToFields, keySimilarity, parseAllMetadata};
